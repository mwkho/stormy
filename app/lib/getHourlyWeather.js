...
const getHourlyWeather = (coordinates) => {
  return axios.get(`https://api.openweathermap.org/data/2.5/onecall?lat=${coordinates.lat}&lon=${coordinates.lon}&appid=94c45c13d9200c5e84dab55fa9169755&exclude=current,minutely,daily,alerts&units=metric`)
  .then(res => {
